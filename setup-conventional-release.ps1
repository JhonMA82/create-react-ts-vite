...
Write-Host "  1) Crea el secreto NPM_TOKEN en GitHub (Settings > Secrets and variables > Actions)." -ForegroundColor Yellow
Write-Host "  2) Usa mensajes de commit convencionales: feat/fix/docs/refactor/test/chore/ci" -ForegroundColor Yellow
Write-Host "  3) Haz push a main; release-please abrirá un Release PR y, al hacer merge, se publicará en npm con provenance." -ForegroundColor Yellow
