...
Co-Authored-By: Claude <noreply@anthropic.com>`
    ...
    await execaCommand(`git commit -m "${commitMessage}"`, { stdio: 'pipe' })
    ...
    console.log(chalk.yellow('   Puedes crear el commit manualmente con: git add . && git commit -m "feat: initial configuration"'))
  }
}
